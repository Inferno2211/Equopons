...
/* compiled from: punjab_coupons.yail */
public class punjab_coupons extends Form implements Runnable {
    static final SimpleSymbol Lit0 = ((SimpleSymbol) new SimpleSymbol("punjab_coupons").readResolve());
    ...
    static final SimpleSymbol Lit63 = ((SimpleSymbol) new SimpleSymbol("Label1").readResolve());
    ...
    static final SimpleSymbol Lit69 = ((SimpleSymbol) new SimpleSymbol("Label3").readResolve());
    ...
    static final SimpleSymbol Lit71 = ((SimpleSymbol) new SimpleSymbol("get-simple-name").readResolve());
    static final SimpleSymbol Lit72 = ((SimpleSymbol) new SimpleSymbol("android-log-form").readResolve());
    static final SimpleSymbol Lit73 = ((SimpleSymbol) new SimpleSymbol("add-to-form-environment").readResolve());
    static final SimpleSymbol Lit74 = ((SimpleSymbol) new SimpleSymbol("lookup-in-form-environment").readResolve());
    static final SimpleSymbol Lit75 = ((SimpleSymbol) new SimpleSymbol("is-bound-in-form-environment").readResolve());
    static final SimpleSymbol Lit76 = ((SimpleSymbol) new SimpleSymbol("add-to-global-var-environment").readResolve());
    static final SimpleSymbol Lit77 = ((SimpleSymbol) new SimpleSymbol("add-to-events").readResolve());
    static final SimpleSymbol Lit78 = ((SimpleSymbol) new SimpleSymbol("add-to-components").readResolve());
    static final SimpleSymbol Lit79 = ((SimpleSymbol) new SimpleSymbol("add-to-global-vars").readResolve());
    static final SimpleSymbol Lit8 = ((SimpleSymbol) new SimpleSymbol("ShowListsAsJson").readResolve());
    static final SimpleSymbol Lit80 = ((SimpleSymbol) new SimpleSymbol("add-to-form-do-after-creation").readResolve());
    static final SimpleSymbol Lit81 = ((SimpleSymbol) new SimpleSymbol("send-error").readResolve());
    static final SimpleSymbol Lit82 = ((SimpleSymbol) new SimpleSymbol("dispatchEvent").readResolve());
    static final SimpleSymbol Lit83 = ((SimpleSymbol) new SimpleSymbol("dispatchGenericEvent").readResolve());
    static final SimpleSymbol Lit84 = ((SimpleSymbol) new SimpleSymbol("lookup-handler").readResolve());
    ...
    public static punjab_coupons punjab_coupons;
    ...
    static {
        ...
        Lit4 = simpleSymbol;
        Lit34 = PairWithPosition.make(simpleSymbol, LList.Empty, "/tmp/1626985825293_0.8746467578274589-0/youngandroidproject/../src/appinventor/ai_hackathonpv2021/Hackathon/punjab_coupons.yail", 221263);
        int[] iArr2 = new int[2];
        iArr2[0] = -1;
    ...
    public punjab_coupons() {
        ModuleInfo.register(this);
        frame frame2 = new frame();
        frame2.$main = this;
        this.get$Mnsimple$Mnname = new ModuleMethod(frame2, 1, Lit71, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.onCreate = new ModuleMethod(frame2, 2, "onCreate", FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.android$Mnlog$Mnform = new ModuleMethod(frame2, 3, Lit72, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.add$Mnto$Mnform$Mnenvironment = new ModuleMethod(frame2, 4, Lit73, 8194);
        this.lookup$Mnin$Mnform$Mnenvironment = new ModuleMethod(frame2, 5, Lit74, 8193);
        this.is$Mnbound$Mnin$Mnform$Mnenvironment = new ModuleMethod(frame2, 7, Lit75, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.add$Mnto$Mnglobal$Mnvar$Mnenvironment = new ModuleMethod(frame2, 8, Lit76, 8194);
        this.add$Mnto$Mnevents = new ModuleMethod(frame2, 9, Lit77, 8194);
        this.add$Mnto$Mncomponents = new ModuleMethod(frame2, 10, Lit78, 16388);
        this.add$Mnto$Mnglobal$Mnvars = new ModuleMethod(frame2, 11, Lit79, 8194);
        this.add$Mnto$Mnform$Mndo$Mnafter$Mncreation = new ModuleMethod(frame2, 12, Lit80, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.send$Mnerror = new ModuleMethod(frame2, 13, Lit81, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.process$Mnexception = new ModuleMethod(frame2, 14, "process-exception", FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.dispatchEvent = new ModuleMethod(frame2, 15, Lit82, 16388);
        this.dispatchGenericEvent = new ModuleMethod(frame2, 16, Lit83, 16388);
        this.lookup$Mnhandler = new ModuleMethod(frame2, 17, Lit84, 8194);
    ...
    public final void run(CallContext $ctx) {
        ...
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            ...
            runtime.setAndCoerceProperty$Ex(Lit0, Lit11, "punjab_coupons", Lit4);
        ...
        this.Label2 = null;
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            Values.writeValues(runtime.addComponentWithinRepl(Lit0, Lit65, Lit66, Boolean.FALSE), $result);
        } else {
            addToComponents(Lit0, Lit67, Lit66, Boolean.FALSE);
        }
        this.Label3 = null;
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
    ...
    static Object lambda16() {
        runtime.setAndCoerceProperty$Ex(Lit59, Lit29, Boolean.TRUE, Lit9);
        runtime.setAndCoerceProperty$Ex(Lit59, Lit24, Lit60, Lit7);
        runtime.setAndCoerceProperty$Ex(Lit59, Lit31, "WhatsAppImage2021-07-20at13.22.26(1).jpeg", Lit4);
    ...
    public class frame extends ModuleBody {
        ...
        public int match1(ModuleMethod moduleMethod, Object obj, CallContext callContext) {
            switch (moduleMethod.selector) {
                case 1:
                    ...
                    return 0;
                case 2:
                    if (!(obj instanceof punjab_coupons)) {
                        return -786431;
                    }
                    callContext.value1 = obj;
                    callContext.proc = moduleMethod;
        ...
        public Object apply4(ModuleMethod moduleMethod, Object obj, Object obj2, Object obj3, Object obj4) {
            ...
            switch (moduleMethod.selector) {
                ...
                case 16:
                    punjab_coupons punjab_coupons = this.$main;
                    try {
                        ...
                        try {
                            ...
                            try {
                                ...
                                try {
                                    punjab_coupons.dispatchGenericEvent(component, str, z, (Object[]) obj4);
                                    return Values.empty;
        ...
        public Object apply0(ModuleMethod moduleMethod) {
            switch (moduleMethod.selector) {
                case 18:
                    return punjab_coupons.lambda2();
                case 19:
                    this.$main.$define();
                    return Values.empty;
                case 20:
                    return punjab_coupons.lambda3();
                case 21:
                    return punjab_coupons.lambda4();
                case 22:
                    return punjab_coupons.lambda5();
                case 23:
                    return punjab_coupons.lambda6();
                case 24:
                    return punjab_coupons.lambda7();
                case 25:
                    return punjab_coupons.lambda8();
                case 26:
                    return punjab_coupons.lambda9();
                case 27:
                    return this.$main.Image2$Click();
                case 28:
                    return punjab_coupons.lambda10();
                case 29:
                    return punjab_coupons.lambda11();
                case 30:
                    return punjab_coupons.lambda12();
                case 31:
                    return punjab_coupons.lambda13();
                case 32:
                    return punjab_coupons.lambda14();
                case 33:
                    return punjab_coupons.lambda15();
                case 34:
                    return punjab_coupons.lambda16();
                case 35:
                    return punjab_coupons.lambda17();
                default:
